  ...
  return (
    <>
      <div className='relative overflow-hidden lg:overflow-visible'>
        ...
        >
          I am a passionate software developer with a strong foundation in front-end technologies such as React, Tailwind CSS, HTML, and JavaScript, along with hands-on experience in backend development using Node.js and Express. My work revolves around creating scalable, efficient, and dynamic web applications that cater to user needs.

I have worked on various projects, from responsive websites to more intricate solutions like interactive GSAP-powered experiences. With a focus on UI/UX design, I ensure that my designs are both visually appealing and accessible, providing seamless user experiences.
        </motion.p>
